...
public class GetKvsCommandTest {
    ...
    public void serializeCommand_ReturnArrayWithCorrectSize() {
        GetKvsCommand command = new GetKvsCommand(dbName, tableName, key);
    ...
    public void serializeCommand_ReturnArrayWithCommandNameObject() {
        ...
        assertEquals("Wrong command name in array", "GET_KEY", commandName.asString());
    }
